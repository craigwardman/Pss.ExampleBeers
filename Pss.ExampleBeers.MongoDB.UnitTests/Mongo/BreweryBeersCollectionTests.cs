...
[TestFixture]
public class BreweryBeersCollectionTests
{
    [SetUp]
    public void SetUp()
    {
    ...
    {
        BreweryBeersCollection.Name.Should().Be("breweryBeers");
    }
    ...
    public void Setup_RegistersClassMap()
    {
        ...
        BsonClassMap.IsClassMapRegistered(typeof(BreweryBeer)).Should().BeTrue();
    }
    ...
    public void Setup_IfCollectionDoesNotExist_CreatesCollection()
    {
        ...
        _mongoDatabaseMock.Verify(
            d => d.CreateCollection(BreweryBeersCollection.Name, It.IsAny<CreateCollectionOptions>(),
    ...
    public void Setup_IfCollectionDoesExist_DoesNotCreateCollection()
    {
        ...
        returnValue.SetupSequence(v => v.MoveNext(It.IsAny<CancellationToken>()))
            .Returns(true)
            .Returns(false);
        returnValue.SetupGet(v => v.Current).Returns(new[] { BreweryBeersCollection.Name });
    ...
    {
        var mockIndexManager = new Mock<IMongoIndexManager<BreweryBeer>>();
        var mockCollection = new Mock<IMongoCollection<BreweryBeer>>();
        mockCollection.SetupGet(c => c.Indexes).Returns(mockIndexManager.Object);
        _mongoDatabaseMock
            .Setup(d => d.GetCollection<BreweryBeer>(BreweryBeersCollection.Name, It.IsAny<MongoCollectionSettings>()))
        ...
        mockIndexManager.Verify(
            i => i.CreateOne(It.IsAny<CreateIndexModel<BreweryBeer>>(), It.IsAny<CreateOneIndexOptions>(),
                It.IsAny<CancellationToken>()), Times.Once);
    }

    private static BreweryBeersCollection GetDefaultSut()
    {
        return new BreweryBeersCollection();
    }
}